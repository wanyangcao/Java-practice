...
public class PortfolioService {
	...
	/*
	 * This service object implements a memory only persistence. This class
	 * should not be taken as an example of how to store data, obviously. When
	 * we get to Chapter Nine, we will add real data persistence with JPA,
	 * Hibernate, and a MySQL database.
	 * 
	 * Note, at this time, Chapter Three, some of the methods of this service
	 * object are only stubs or partial implementations of functionality. This
	 * class will become more complete with each chapter's version of the Struts
	 * 2 Portfolio.
	 */
	...
	/*
	 * At this point the application doesn't actually associate the images with
	 * a portfolio. This just saves the file to the filesystem
	 */
	...
	/*
	 * Returns a user object if the username and password are valid. Returns
	 * null otherwise.
	 */
	public User authenticateUser(String username, String password) {
		...
		/*
		 * Retrieve a user object. We're building a copy so that it mirrors the
		 * behaviour of the persistence backed object.
		 */
	...
	/*
	 * This is so we can keep our memory persistence objects separate from the
	 * objects used by the application. Pretending like the memory map is more
	 * of a persistence storage so that we have methods more applicable to
	 * persistent storage when we change this.
	 */
